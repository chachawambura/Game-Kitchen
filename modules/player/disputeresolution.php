...
$games = playModel::disputeMyGamesByStatus(MYID);
//print_r($games);
...
foreach($games as $game)
{
    ...
    $winst =$game->win_status;
    if($game->win_status=="pending" &&  $myid==$gameId && $result2=="Yes" || $myid==$player2 && $result1=="Yes" && $winst=="pending" ){
