 ...
 if(isset($_POST['submitClaimPlayer2']) && $_POST['submitClaimPlayer2'] == "Submit Results")
 {
 	...
 	else
 	{
 		if(!isset($_POST['claimNow']))
 			...
 			{
 				echo playModel::submitMyGameClaim2($_POST);
 			}
   ...
   ?>
        ...
        <form class="form" role="form" method="post" action="index.php?acc=games&page=player2_prize&currentgameId" id="signup-nav2">        
        <input type="hidden" class="form-control" name="gameId" value="<?php echo $currentgameId?>"/>
         ...
         <input type="checkbox" class="check"  name="claimNow" value="Yes" id="defaultUnchecked">
        <label class="custom-control-label" for="defaultUnchecked">Won</label>
        <input type="checkbox" class="check"  name="claimNow"  value="No" id="defaultUnchecked">
        <label class="custom-control-label" for="defaultUnchecked">Lost</label>
        </div>
        <div class="col-md-12 form-group">
    	<div class="col-md-12 text-center">
    	 <input type="submit" name="submitClaimPlayer2" class="btn btn-success" value="Submit Results" />
