...
if(isset($_POST['submitDirectChallengeGame']) && $_POST['submitDirectChallengeGame'] == "Submit Game")
{
...
<form class="form" role="form" method="post" action="index.php?acc=direct" id="signup-nav2">
    <div class="col-md-12 form-group">

    <input type="hidden" name="userId" value="<?php echo $currId;?>">
    
    <input type="hidden" name="player2Id" value="<?php echo $joingameId;?>">
...
<div class="col-md-4">
    	...
    	echo '<p class="text-center isa_error">Your current balance is low. Please top up to play</p>';
    		...
    		echo '<input type="submit" name="submitDirectChallengeGame" class="btn btn-success" value="Submit Game" />';
    	}
    	?>
